...
- **type** (**Required**, string):  Meter type. Currently `amiplus`, `apator08`, `apator162`, `bmeters`, `elf`, `evo868`, `hydrocalm3`, `izar`, `itron`, `mkradio3`, `mkradio4`, `vario451`, `ultrimis`, `unismart`, `fhkvdataiii`, `qwater` are supported.
