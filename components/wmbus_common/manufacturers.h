...
#define LIST_OF_MANUFACTURERS                                                  \
  ...
  X(ACN, MANFCODE('A', 'C', 'N'),                                              \
    "ACN Advanced Communications Networks, Switzerland")                       \
  X(ACS, MANFCODE('A', 'C', 'S'),                                              \
    "Tianjin Chuangshi Technology Developing, China")                          \
  ...
  X(ADE, MANFCODE('A', 'D', 'E'),                                              \
    "Yantai Aerospace Delu Energy saving Technology, China")                   \
  ...
  X(ARG, MANFCODE('A', 'R', 'G'),                                              \
    "ARGO group of companies, Russian Federation")                             \
  ...
  X(BFW, MANFCODE('B', 'F', 'W'),                                              \
    "BFW Buero fuer Waermemesstechnik OHG, Germany")                           \
  ...
  X(BOV, MANFCODE('B', 'O', 'V'),                                              \
    "JiaXing Bove Intelligent Technology, China")                              \
  ...
  X(BRT, MANFCODE('B', 'R', 'T'),                                              \
    "BEREKET TEKNOLOJIK OELCUM SISTEMLERI BIL ELK INS ITH IHR SAN VE TIC "     \
    "STI, Turkey")                                                             \
  X(BSC, MANFCODE('B', 'S', 'C'),                                              \
    "Sanaye Sanjesh Energy Behineh Sazan Toos, Iran")                          \
  X(BSD, MANFCODE('B', 'S', 'D'), "BSED, Germany")                             \
  X(BSE, MANFCODE('B', 'S', 'E'), "Basari Elektronik, Turkey")                 \
  X(BSM, MANFCODE('B', 'S', 'M'),                                              \
    "Bluestar Electrical Meter Research Institute, China")                     \
  ...
  X(BXC, MANFCODE('B', 'X', 'C'),                                              \
    "Beijing Fuxing Xiao Cheng Electronic Technology Stock Xisanhuan Beilu, "  \
    "China")                                                                   \
  ...
  X(CHE, MANFCODE('C', 'H', 'E'),                                              \
    "Shandong Chenhui Electronic Technology, China")                           \
  X(CHM, MANFCODE('C', 'H', 'M'),                                              \
    "Chung Hsin Electric and Machinery Manufacturing, Taiwan")                 \
  ...
  X(CKT, MANFCODE('C', 'K', 'T'),                                              \
    "CKT Elektrik Elektronik Sanayi ve Ticaret, Turkey")                       \
  ...
  X(COH, MANFCODE('C', 'O', 'H'),                                              \
    "COHEAT Future Business Centre, United Kingdom")                           \
  ...
  X(CRW, MANFCODE('C', 'R', 'W'),                                              \
    "Xuzhou Runwu Science and Technology Development, China")                  \
  ...
  X(CTT, MANFCODE('C', 'T', 'T'),                                              \
    "DLMS User Association Conformance, Switzerland")                          \
  ...
  X(CYE, MANFCODE('C', 'Y', 'E'),                                              \
    "Quanzhou Chiyoung Electronics Technology, China")                         \
  ...
  X(DBE, MANFCODE('D', 'B', 'E'),                                              \
    "Decibels Electronics P Decibels Electronics, India")                      \
  ...
  X(DHA, MANFCODE('D', 'H', 'A'),                                              \
    "Shanghai dahua measuring auto control instruments manufactory, China")    \
  ...
  X(ECH, MANFCODE('E', 'C', 'H'),                                              \
    "Networked Energy Services Corporation, United States of America")         \
  ...
  X(EES, MANFCODE('E', 'E', 'S'),                                              \
    "Eletra Industria e Comercio de Medidores Eletricos, Brazil")              \
  ...
  X(EGW, MANFCODE('E', 'G', 'W'),                                              \
    "Enermess Energie Mess und Servicedienste, Germany")                       \
  ...
  X(ELE, MANFCODE('E', 'L', 'E'),                                              \
    "Elster Electricity, United States of America")                            \
  ...
  X(EMC, MANFCODE('E', 'M', 'C'),                                              \
    "Embedded Communication Systems, Switzerland")                             \
  X(EME, MANFCODE('E', 'M', 'E'), "SC Electromagnetica, Romania")              \
  X(EMF, MANFCODE('E', 'M', 'F'),                                              \
    "IT Beratung Energiemanagement Flammang, Germany")                         \
  X(EMH, MANFCODE('E', 'M', 'H'),                                              \
    "EMH metering formerly EMH Elektrizitatszahler")                           \
  ...
  X(ESD, MANFCODE('E', 'S', 'D'),                                              \
    "Edelstrom Electronic Devices and Designing, United Arab Emirates")        \
  X(ESE, MANFCODE('E', 'S', 'E'), "ESE Nordic, Sweden")                        \
  X(ESG, MANFCODE('E', 'S', 'G'), "ESG, South Korea")                          \
  X(ESH, MANFCODE('E', 'S', 'H'), "EMSYCON, Germany")                          \
  X(ESI, MANFCODE('E', 'S', 'I'),                                              \
    "Monosan Monofaze Elektrik Motorlari, Turkey")                             \
  X(ESM, MANFCODE('E', 'S', 'M'),                                              \
    "Monosan Monofaze Elektrik Motorlari, Turkey")                             \
  X(ESN, MANFCODE('E', 'S', 'N'), "Zhejiang Eastron Electronic, China")        \
  X(ESO, MANFCODE('E', 'S', 'O'),                                              \
    "Monosan Monofaze Elektrik Motorlari, Turkey")                             \
  ...
  X(ETO, MANFCODE('E', 'T', 'O'),                                              \
    "Sphere of economical technologies, Russian Federation")                   \
  ...
  X(FLX, MANFCODE('F', 'L', 'X'),                                              \
    "FLEXIM Flexible Industriemesstechnik, Germany")                           \
  ...
  X(FST, MANFCODE('F', 'S', 'T'),                                              \
    "FieldServer Technologies, United States of America")                      \
  ...
  X(GLX, MANFCODE('G', 'L', 'X'),                                              \
    "Electrical Equipment Joint Stock Corporation, Vietnam")                   \
  ...
  X(GNY, MANFCODE('G', 'N', 'Y'),                                              \
    "JiangSu GuoNeng Instrument Technology, China")                            \
  ...
  X(GWI, MANFCODE('G', 'W', 'I'),                                              \
    "George Wilson Industries Aldermans Green Industrial Estate, United "      \
    "Kingdom")                                                                 \
  X(HAG, MANFCODE('H', 'A', 'G'), "Hager Electro, Germany")                    \
  X(HAK, MANFCODE('H', 'A', 'K'), "Hako, Slovakia")                            \
  X(HBY, MANFCODE('H', 'B', 'Y'),                                              \
    "HENAN HUABIAO INSTRUMENT TECHNOLOGY, China")                              \
  ...
  X(HDX, MANFCODE('H', 'D', 'X'),                                              \
    "Beijing TianRuiXiangDe Measuring Technology, China")                      \
  ...
  X(HEX, MANFCODE('H', 'E', 'X'),                                              \
    "Shenzhen Hexcell Electronics Technology, China")                          \
  X(HFI, MANFCODE('H', 'F', 'I'),                                              \
    "Nanjing Hu Measurement Control Technology, China")                        \
  ...
  X(HIE, MANFCODE('H', 'I', 'E'),                                              \
    "Shenzhen Holley South Electronics Technology, China")                     \
  ...
  X(HTI, MANFCODE('H', 'T', 'I'),                                              \
    "Shandong Hetong Information Technology, China")                           \
  ...
  X(HWM, MANFCODE('H', 'W', 'M'),                                              \
    "Beijing Hongwei Chaoda Instrument Manufacturing, China")                  \
  ...
  X(HXW, MANFCODE('H', 'X', 'W'),                                              \
    "Hangzhou Xili Watthour Meter Manufacture, China")                         \
  ...
  X(HZZ, MANFCODE('H', 'Z', 'Z'),                                              \
    "Huizhou Zhongcheng Electronic Technology, China")                         \
  ...
  X(ICE, MANFCODE('I', 'C', 'E'),                                              \
    "Icoal incorporated, United States of America")                            \
  ...
  X(ICT, MANFCODE('I', 'C', 'T'),                                              \
    "International Control Metering Technologies, Germany")                    \
  ...
  X(IID, MANFCODE('I', 'I', 'D'),                                              \
    "PT INDUSTRI TELEKOMUNIKASI Persero, Indonesia")                           \
  ...
  X(IKE, MANFCODE('I', 'K', 'E'),                                              \
    "IK Elektronik Friedrichsgruener Str, Germany")                            \
  ...
  X(ISI, MANFCODE('I', 'S', 'I'),                                              \
    "Akcionarsko Drustvo Insa Industrija Satova, Serbia")                      \
  ...
  X(ITB, MANFCODE('I', 'T', 'B'),                                              \
    "Itron Solucoes para Energia e Aguaa, Brazil")                             \
  ...
  X(ITU, MANFCODE('I', 'T', 'U'),                                              \
    "ITRON United States Itron, United States of America")                     \
  X(ITW, MANFCODE('I', 'T', 'W'), "ITRON Water, France")                       \
  X(ITX, MANFCODE('I', 'T', 'X'),                                              \
    "IDEAL TECHNICAL SOLUTIONS, United Arab Emirates")                         \
  ...
  X(IYI, MANFCODE('I', 'Y', 'I'),                                              \
    "KAYI ENERGY Hacettepe Universitesi, Turkey")                              \
  ...
  X(JGD, MANFCODE('J', 'G', 'D'),                                              \
    "tianjin guangdaweiye measuring instrument technology, China")             \
  X(JGF, MANFCODE('J', 'G', 'F'),                                              \
    "Janz Contagem e Gestao de Fluidos, Portugal")                             \
  X(JGH, MANFCODE('J', 'G', 'H'), "ITSQUARE, South Korea")                     \
  X(JHA, MANFCODE('J', 'H', 'A'), "Zhejiang JiaHe Instrument, China")          \
  X(JHM, MANFCODE('J', 'H', 'M'),                                              \
    "Changzhou Jianhu Intelligentize Meter, China")                            \
  X(JJN, MANFCODE('J', 'J', 'N'),                                              \
    "BeiJing Fine Clean Enery Technology, China")                              \
  ...
  X(JSM, MANFCODE('J', 'S', 'M'),                                              \
    "Jining Goldwater Science Technology, China")                              \
  ...
  X(JWR, MANFCODE('J', 'W', 'R'),                                              \
    "Shandong jingwei telecommunications equipment, China")                    \
  X(JWS, MANFCODE('J', 'W', 'S'),                                              \
    "Wesson energy saving technology tianjin, China")                          \
  X(JYS, MANFCODE('J', 'Y', 'S'),                                              \
    "Beijing Jingyuan instrument company, China")                              \
  ...
  X(KNI, MANFCODE('K', 'N', 'I'),                                              \
    "zhangzhou keneng electrical equipment, China")                            \
  X(KNX, MANFCODE('K', 'N', 'X'), "KONNEX based users Siemens Regensburg")     \
  X(KPD, MANFCODE('K', 'P', 'D'),                                              \
    "Korea Electric Power Industrial Development, South Korea")                \
  ...
  X(LCR, MANFCODE('L', 'C', 'R'),                                              \
    "ShanDong LiChuang Science and Technology, China")                         \
  ...
  X(LGC, MANFCODE('L', 'G', 'C'),                                              \
    "Landis Gyr Equipamentos de Medicaoa Brasil, Brazil")                      \
  ...
  X(MEL, MANFCODE('M', 'E', 'L'),                                              \
    "Mikroelektronika a d, Bosnia and Herzegovina")                            \
  ...
  X(MIL, MANFCODE('M', 'I', 'L'),                                              \
    "Milur Smart System liability company, Russian Federation")                \
  X(MIM, MANFCODE('M', 'I', 'M'), "n Intelligence Meters Sdn Bhd, Malaysia")   \
  X(MIR, MANFCODE('M', 'I', 'R'),                                              \
    "MIR Research and Production Association, Russian Federation")             \
  ...
  X(MKE, MANFCODE('M', 'K', 'E'),                                              \
    "MKEK Genel Mudurlugu Gazi Fisek ELSA, Turkey")                            \
  ...
  X(MMS, MANFCODE('M', 'M', 'S'),                                              \
    "Brunswick Bowling and Billiards UK, United Kingdom")                      \
  ...
  X(MPA, MANFCODE('M', 'P', 'A'),                                              \
    "Mega Power Automation International, Hong Kong")                          \
  ...
  X(MSY, MANFCODE('M', 'S', 'Y'),                                              \
    "MAK SAY Elektrik Elektronik Malzemeleri, Turkey")                         \
  X(MTC, MANFCODE('M', 'T', 'C'), "Metering Technology Corporation")           \
  X(MTD, MANFCODE('M', 'T', 'D'),                                              \
    "Removed November, United States of America")                              \
  ...
  X(MUK, MANFCODE('M', 'U', 'K'),                                              \
    "Meters UK Whitegate White Lund Trading Estate, United Kingdom")           \
  ...
  X(NAE, MANFCODE('N', 'A', 'E'),                                              \
    "Nanjing NengRui Automation Equipment, China")                             \
  X(NAR, MANFCODE('N', 'A', 'R'),                                              \
    "NARI Group Corporation NARI Technology Development, China")               \
  ...
  X(NEE, MANFCODE('N', 'E', 'E'),                                              \
    "Northern Electric Equipment Joint Stock Company, Vietnam")                \
  ...
  X(NZR, MANFCODE('N', 'Z', 'R'),                                              \
    "Nordwestdeutsche Zaehlerrevision Ing Aug Knemeyer, Germany")              \
  X(OAS, MANFCODE('O', 'A', 'S'), "Omni Agate Systems, India")                 \
  X(OBC, MANFCODE('O', 'B', 'C'),                                              \
    "shandong oubiao information Technology, China")                           \
  ...
  X(OYK, MANFCODE('O', 'Y', 'K'),                                              \
    "GULLWING TIANJIN INDUSTRY DEVELOPMENGT, China")                           \
  ...
  X(PFI, MANFCODE('P', 'F', 'I'),                                              \
    "PFIFFNER Instrument Transformers, Switzerland")                           \
  ...
  X(PII, MANFCODE('P', 'I', 'I'),                                              \
    "PiiGAB Processinformation i Goteborg, Sweden")                            \
  ...
  X(PVT, MANFCODE('P', 'V', 'T'),                                              \
    "Pavo Tasarim Uretim Elektronik Tic, Turkey")                              \
  ...
  X(RAM, MANFCODE('R', 'A', 'M'),                                              \
    "Rossweiner Armaturen und Messgeraete OHG, Germany")                       \
  ...
  X(RIM, MANFCODE('R', 'I', 'M'),                                              \
    "CJSC Radio and Microelectronics, Russian Federation")                     \
  ...
  X(ROK, MANFCODE('R', 'O', 'K'),                                              \
    "ROKIP Liability Company, Russian Federation")                             \
  X(RSA, MANFCODE('R', 'S', 'A'), "Rahrovan Sepehr Andisheh")                  \
  X(RSM, MANFCODE('R', 'S', 'M'),                                              \
    "Zhejiang Risesun Science and Technology, China")                          \
  ...
  X(SAM, MANFCODE('S', 'A', 'M'),                                              \
    "Siemens OEsterreich AMIS Automated Metering and Information System, "     \
    "Austria")                                                                 \
  ...
  X(SCE, MANFCODE('S', 'C', 'E'),                                              \
    "Seo Chang Electric Communication, South Korea")                           \
  ...
  X(SHD, MANFCODE('S', 'H', 'D'),                                              \
    "Beijing SanHuaDeBao Energy Technoligy, China")                            \
  ...
  X(SIL, MANFCODE('S', 'I', 'L'),                                              \
    "Silicon Laboratories, United States of America")                          \
  ...
  X(SIV, MANFCODE('S', 'I', 'V'),                                              \
    "Sieverding Heizungs und Sanitaertechnik, Germany")                        \
  ...
  X(SLP, MANFCODE('S', 'L', 'P'),                                              \
    "Sylop spolka z ograniczona odpowiedzialnoscia sp k, Poland")              \
  ...
  X(SMC, MANFCODE('S', 'M', 'C'),                                              \
    "Sierra Monitor Corporation, United States of America")                    \
  ...
  X(SMX, MANFCODE('S', 'M', 'X'),                                              \
    "Smart Meters Technologies Sdn Bhd, Malaysia")                             \
  ...
  X(SRE, MANFCODE('S', 'R', 'E'),                                              \
    "Guangzhou Sunrise Electronics Development, China")                        \
  X(SRF, MANFCODE('S', 'R', 'F'), "Saraf Industries, India")                   \
  X(SRN, MANFCODE('S', 'R', 'N'),                                              \
    "Shandong SARON Intelligent Technology, China")                            \
  ...
  X(SSN, MANFCODE('S', 'S', 'N'),                                              \
    "Silver Spring Networks, United States of America")                        \
  X(SSS, MANFCODE('S', 'S', 'S'), "SUEZ SMART SOLUTIONS, France")              \
  X(SST, MANFCODE('S', 'S', 'T'),                                              \
    "Qingdao Haina Electric Automation Systems, China")                        \
  ...
  X(STV, MANFCODE('S', 'T', 'V'),                                              \
    "STV Automation Branch of STV Electronic, Germany")                        \
  X(STZ, MANFCODE('S', 'T', 'Z'),                                              \
    "Steinbeis Innovation Center Embedded Design and Networking, Germany")     \
  ...
  X(SYC, MANFCODE('S', 'Y', 'C'),                                              \
    "Sycous Leeds Innovation Centre, United Kingdom")                          \
  ...
  X(TAY, MANFCODE('T', 'A', 'Y'),                                              \
    "Taytech Otomasyon ve Bilisim Teknolojileri Sti, Turkey")                  \
  X(TAZ, MANFCODE('T', 'A', 'Z'), "PoyeshGaran Sahandzaran Tabrizazma, Iran")  \
  X(TBN, MANFCODE('T', 'B', 'N'), "TBEA Nanjing Intelligent Electric, China")  \
  X(TBS, MANFCODE('T', 'B', 'S'),                                              \
    "TEBAS END ISI SIS INS TUR SAN VE TIC STI, Turkey")                        \
  ...
  X(TCZ, MANFCODE('T', 'C', 'Z'),                                              \
    "Tianjin Chuangzhan Tongcheng Technology Development, China")              \
  ...
  X(TEO, MANFCODE('T', 'E', 'O'),                                              \
    "ubitricity Gesellschaft fur verteilte Energiesysteme mbH, Germany")       \
  ...
  X(TKS, MANFCODE('T', 'K', 'S'),                                              \
    "Teksan Teknolojik OElcum Sistemleri, Turkey")                             \
  ...
  X(TMZ, MANFCODE('T', 'M', 'Z'),                                              \
    "TMZ Thuringer Mess und Zaehlerwesen Service, Germany")                    \
  X(TOP, MANFCODE('T', 'O', 'P'), "KMB systems, Czech Republic")               \
  X(TPB, MANFCODE('T', 'P', 'B'), "2 Plus AD, Bulgaria")                       \
  X(TPC, MANFCODE('T', 'P', 'C'),                                              \
    "Taipit measuring equipment, Russian Federation")                          \
  ...
  X(UGT, MANFCODE('U', 'G', 'T'),                                              \
    "DP UKRGAZTECH Ukrainian gas technologies, Ukraine")                       \
  ...
  X(VDP, MANFCODE('V', 'D', 'P'),                                              \
    "Plant Vodopribor management company, Russian Federation")                 \
  ...
  X(VIM, MANFCODE('V', 'I', 'M'),                                              \
    "VIEN ENERJI SISTEMLERI SANAYI VE TICARET SIRKETI, Turkey")                \
  ...
  X(VSE, MANFCODE('V', 'S', 'E'),                                              \
    "Valenciana Smart Energy of Mediterranean Sea, Spain")                     \
  ...
  X(WAI, MANFCODE('W', 'A', 'I'),                                              \
    "Chongqing WECAN Precision Instruments, China")                            \
  ...
  X(WEG, MANFCODE('W', 'E', 'G'),                                              \
    "WEG Equipamentos Eletricos Automacao, Brazil")                            \
  ...
  X(WKL, MANFCODE('W', 'K', 'L'),                                              \
    "Shenyang jia DE lian yi energy technology, China")                        \
  ...
  X(WNW, MANFCODE('W', 'N', 'W'),                                              \
    "Wistron NeWeb Corporation Marketing Center, Taiwan")                      \
  ...
  X(WSG, MANFCODE('W', 'S', 'G'),                                              \
    "ZHEJIANG WELLSUN INTELLIGENT TECHNOLOGY, China")                          \
  ...
  X(XTY, MANFCODE('X', 'T', 'Y'),                                              \
    "LianYuanGang Tengyue Electronics Technology")                             \
  X(YDD, MANFCODE('Y', 'D', 'D'), "Jilin Yongda Group")                        \
  X(YDS, MANFCODE('Y', 'D', 'S'), "YIDU Smart Technology Beijing, China")      \
  X(YFC, MANFCODE('Y', 'F', 'C'),                                              \
    "Yufeng Changhui Automation Instrument, China")                            \
  X(YGM, MANFCODE('Y', 'G', 'M'),                                              \
    "YGM Shandong Yiguang heat metering technology, China")                    \
  ...
  X(YZR, MANFCODE('Y', 'Z', 'R'),                                              \
    "Cangzhou City Hebei Electronic Technology, China")                        \
  X(ZAG, MANFCODE('Z', 'A', 'G'), "Zellweger Uster, Switzerland")              \
  X(ZAP, MANFCODE('Z', 'A', 'P'), "Zaptronix")                                 \
  X(ZAR, MANFCODE('Z', 'A', 'R'), "SNC ZARALAB, Bulgaria")                     \
  X(ZCH, MANFCODE('Z', 'C', 'H'),                                              \
    "Zhejiang Chaorong Electric Technology, China")                            \
  ...
  X(ZFY, MANFCODE('Z', 'F', 'Y'),                                              \
    "Hang Zhou Fu Yang Instrument General Factory, China")                     \
  X(ZGX, MANFCODE('Z', 'G', 'X'), "ZIGNUX TECHNOLOGY, Spain")                  \
  X(ZIP, MANFCODE('Z', 'I', 'P'),                                              \
    "St Petersburg Meters Factory, Russian Federation")                        \
  X(ZIV, MANFCODE('Z', 'I', 'V'), "ZIV Aplicaciones y Tecnologia")             \
  X(ZJY, MANFCODE('Z', 'J', 'Y'),                                              \
    "Zhejiang Jiayou Thermal Technology Equipment, China")                     \
  ...
  X(ZTX, MANFCODE('Z', 'T', 'X'),                                              \
    "ZHEJIANG TANCY INSTRUMENT TECHNOLOGY eTD, China")                         \
